    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Empowering Project Management Technology students at Lagos State University."
                />
                <meta
                    name="keywords"
                    content="Project Management, Technology, AMATECH, Lagos State University"
                />
                ...
                <meta
                    property="og:url"
                    content="https://amatech-learning-hub.com"
                />
            ...
            <div className="min-h-screen bg-white">
                    ...
                    <div className="max-w-7xl mx-auto relative z-10 w-full">
                        ...
                        >
                            <motion.div variants={fadeInUp}>
                                ...
                                >
                                    Association of Management Technology
                                    Students
                                </Badge>
                            </motion.div>
                            ...
                            <motion.p
                                ...
                                variants={fadeInUp}
                            >
                                Access comprehensive course materials, and excel
                                in your Project Management Technology studies at
                                            ...
                                            <div className="space-y-8">
                                                ...
                                                <div className="text-center">
                                                    <p className="text-gray-600 italic text-lg">
                                                        ...
                                                        studies and helped me
                                                        excel in my coursework."
                                                    </p>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            ...
                            <p className="text-xl text-gray-600">
                                ...
                                students about their experience with the
                                platform
                            </p>
                        </motion.div>
                ...
                {/* CTA Section */}
                <section className="py-16 sm:py-20 bg-gray-100 bg-green-500">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="max-w-3xl mx-auto text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 text-center">
                        ...
                        <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4 text-center">
                            Join fellow students who have streamlined their
                            studies with our centralized learning platform.
                        </p>
                                ...
                                <>
                                    {isAuthenticated ? (
                                        ...
                                        >
                                            <AnimatedButton
                                                size="lg"
                                                className="text-lg px-8 py-6 w-full sm:w-auto inline-flex items-center justify-center bg-white text-green-800 border border-green-800"
                                            >
                                                Go to Dashboard
                                            </AnimatedButton>
                                        </Link>
                                        ...
                                        <>
                                            ...
                                            >
                                                <AnimatedButton
                                                    size="lg"
                                                    className="text-lg px-8 py-6 w-full sm:w-auto inline-flex items-center justify-center bg-white text-green-600 border border-green-600"
                                                >
                                                    Join fellow students
                                                </AnimatedButton>
                                            </Link>
                                            ...
                                            >
                                                <AnimatedButton
                                                    size="lg"
                                                    variant="outline"
                                                    className="text-lg px-8 py-6 w-full sm:w-auto inline-flex items-center justify-center border border-white text-white bg-green-500"
                                                >
                                                    Login now
                                                </AnimatedButton>
                                            </Link>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            <p className="text-sm sm:text-base text-gray-600">
                                ...
                                Management Technology Students, Lagos State
                                University. <br className="hidden sm:inline" />
                                Developed with ❤️ by the{" "}
                                <Link href="https://nurenijamiu.tech">
                                    Nureni Jamiu
                                </Link>
                                . All rights reserved.
                            </p>
