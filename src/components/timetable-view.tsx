        ...
        <div className="space-y-4 sm:space-y-6 p-4 sm:p-6">
            <div className="flex flex-col space-y-2">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">
                    Level {currentUser.level} timetable for{" "}
            ...
            <Tabs
                ...
                onValueChange={(value) =>
                    setActiveSemester(value as "1" | "2" as any)
                }
                className="w-full"
            >
                ...
                <TabsContent value="1" className="mt-6">
                    <TimetableContent
                        semester={1}
                        timetableEntries={
                            activeSemester === 1 ? timetableEntries : []
                        }
                        timetableGrid={
                            activeSemester === 1 ? timetableGrid : {}
                        }
                ...
                <TabsContent value="2" className="mt-6">
                    <TimetableContent
                        semester={2}
                        timetableEntries={
                            activeSemester === 2 ? timetableEntries : []
                        }
                        timetableGrid={
                            activeSemester === 2 ? timetableGrid : {}
                        }
            ...
            <Card>
                <CardContent className="flex flex-col items-center justify-center py-16">
                    ...
                    <p className="text-muted-foreground text-center mb-4">
                        ...
                        {semester === 1 ? "first" : "second"} semester timetable
                        yet.
                    </p>
        ...
        <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">
                    {timetableEntries.length} class
                    {timetableEntries.length !== 1 ? "es" : ""} scheduled
                </p>
            </div>
            ...
            <CardContent className="p-2 sm:p-6">
                <div className="overflow-x-auto">
                    <Table className="min-w-[800px]">
                        <TableHeader>
                            <TableRow>
                                <TableHead className="w-20 sm:w-32 text-xs sm:text-sm">
                                    Time
                                </TableHead>
                                {DAYS_OF_WEEK.map((day) => (
                                    <TableHead
                                        key={day}
                                        className="text-center min-w-24 sm:min-w-32 text-xs sm:text-sm"
                                    >
                                        <span className="hidden sm:inline">
                                            {day}
                                        </span>
                        ...
                        <TableBody>
                            {TIME_SLOTS.map((time) => (
                                <TableRow key={time}>
                                    <TableCell className="font-medium text-xs sm:text-sm py-1 sm:py-2">
                                        <span className="hidden sm:inline">
                                            {time}
                                        </span>
                                        <span className="sm:hidden">
...
function TimetableEntryCard({
    ...
    return (
        <Card className={compact ? "h-12 sm:h-16" : ""}>
            <CardContent
                className={`p-2 sm:p-3 ${compact ? "py-1 sm:py-2" : ""}`}
            >
                    ...
                    <div className="space-y-1 flex-1 min-w-0">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                >
                                    {compact && entry.location.length > 8
                                        ? entry.location.substring(0, 8) + "..."
                                        : entry.location}
                                </span>
                            </div>
                        </div>
                                ...
                                <AlertDialogContent className="max-w-sm sm:max-w-lg">
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription className="text-sm">
                                            ...
                                            class from your timetable? This
