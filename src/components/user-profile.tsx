...
export function UserProfile({ isOpen, onClose }: UserProfileProps) {
  ...
  const handleAvatarUpload = async (
      ...
      toast.promise(uploadAvatarMutation.mutateAsync(file), {
          ...
          >
              <div className="flex items-center gap-6">
                  ...
                  <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                          Level {currentUser.level ?? "N/A"} • Semester{" "}
                          {currentUser.currentSemester ?? "N/A"}
                      </p>
                      {uploadAvatarMutation.isPending && (
              ...
              <FormGrid columns={2}>
                  ...
                  <FormField label="Academic Level" required>
                      {isEditing ? (
                          ...
                          <Input
                              value={`${currentUser.level ?? 100} Level`}
                              disabled
                          />
                      )}
                  </FormField>
                  ...
                  <FormField label="Current Semester" required>
                      {isEditing ? (
                          ...
                          <Input
                              value={`${currentUser.currentSemester ?? 1}${
