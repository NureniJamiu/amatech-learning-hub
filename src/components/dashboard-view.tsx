    ...
    <div className="space-y-6">
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground">
          Welcome to your learning dashboard. Here's what's happening in your
          academic world.
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {currentUser.level} Level, Semester {currentUser.currentSemester}
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardHeader className="flex justify-between items-center">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button size="sm" className="rounded cursor-pointer">
                  Add Class
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  <Button onClick={addTimetableEntry}>Add to Timetable</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          </CardHeader>
                  ...
                  <TableRow key={entry.id}>
                    ...
                    <TableCell className="text-right">
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => handleViewCourse(entry.course)}
                      >
                        View Course
                      </Button>
                    </TableCell>
